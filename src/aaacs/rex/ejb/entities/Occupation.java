...
@Entity(name="Occupation") @Table(name="\"tOccupations\"")
public class Occupation extends BaseEntity implements Serializable
{
	 ...
	 * Entity table name
	 */
	public static final String entityTableName = "\"tOccupations\"";

	static public Occupation findByIdk(EntityManager manager, long inputIdk)
	{
		try { return (Occupation) BaseEntity.findByIdk(manager, Occupation.class, inputIdk); }
		catch (Exception e) { return null; }
	}

	static public List findOccupationByFields(EntityManager manager,
		Map<String,Object> searchFields)
	{
		String[] tables = { entityTableName };
		return BaseEntity.findByFields(manager, tables, null,
			searchFields, "List<Occupation>");
	}
	...
	static public List findOccupationByCondition(EntityManager manager,
		String condition, Vector<Object> conditionParameters)
	{
		String[] tables = { entityTableName };
		return BaseEntity.findByCondition(manager, tables, null,
			condition, conditionParameters, "List<Occupation>");
	}
	...
	static public Map<String, List<MsgArgsPair>> validateOccupation(Occupation occupation,
		boolean userSuppliedIdk, List<String> specificFields, boolean exclude)
	{
		return occupation.validateAllFields(userSuppliedIdk, specificFields, exclude);
	}
	...
	public Occupation() {}
	public Occupation(Map<String, Object> fields)
